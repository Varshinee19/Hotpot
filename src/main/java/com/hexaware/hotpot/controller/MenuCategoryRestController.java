...
public class MenuCategoryRestController {
	...
	@PostMapping("/add")
	public MenuCategories addCategory(@RequestBody MenuCategoriesDto dto) {
		return service.addCategory(dto);
	}
	@PutMapping("/update/{categoryId}")
	public MenuCategories updateCategory(@PathVariable Integer categoryId,MenuCategoriesDto dto) {
	...
	public MenuCategories getById(@PathVariable Integer categoryId){
